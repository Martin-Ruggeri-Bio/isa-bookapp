...
describe('Profile Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call Profile query and add missing value', () => {
      const profile: IProfile = { id: 456 };
      const folowers: IProfile[] = [{ id: 31214 }];
      profile.folowers = folowers;

      const profileCollection: IProfile[] = [{ id: 34961 }];
      jest.spyOn(profileService, 'query').mockReturnValue(of(new HttpResponse({ body: profileCollection })));
      const additionalProfiles = [...folowers];
    ...
    it('Should update editForm', () => {
      ...
      profile.user = user;
      const folowers: IProfile = { id: 76811 };
      profile.folowers = [folowers];
      ...
      expect(comp.profilesSharedCollection).toContain(folowers);
